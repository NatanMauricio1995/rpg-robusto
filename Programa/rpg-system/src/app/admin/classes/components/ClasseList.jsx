...
import styles from './ClasseList.module.css';

const ClasseList = ({ data, loading, onEdit, onDelete, onView }) => {
  const columns = [
    { key: 'nome', label: 'Nome', sortable: true },
    { key: 'dadoVida', label: 'Dado Vida', render: (val) => `D${val}` },
    { key: 'quantidadePericias', label: 'Perícias' },
    {
      key: 'ativo',
      label: 'Status',
  ...
  return <DataGrid columns={columns} data={data} loading={loading} emptyMessage="Nenhuma classe encontrada." />;
};
