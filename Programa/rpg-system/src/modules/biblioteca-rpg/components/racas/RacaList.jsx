...
import styles from './RacaList.module.css';

const RacaList = ({ data, loading, onEdit, onDelete, onView }) => {
  const columns = [
    { key: 'nome', label: 'Nome', sortable: true },
    { key: 'tamanho', label: 'Tamanho' },
    { key: 'deslocamento', label: 'Desloc.', render: (val) => `${val}m` },
    {
      key: 'ativo',
      label: 'Status',
  ...
  return <DataGrid columns={columns} data={data} loading={loading} emptyMessage="Nenhuma raça encontrada." />;
};

export default RacaList;
